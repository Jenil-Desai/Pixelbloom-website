...
const WallpaperCard: React.FC<WallpaperCardProps> = ({id, title, imageUrl, platform, category, likes, onDelete}) => {
    return (<div
        ...
        <div className="p-4">
            ...
            <div className="mt-4 flex items-center justify-between">
                ...
                <button className="flex items-center gap-1 text-sm transition-colors duration-300 cursor-pointer"
                        onClick={() => onDelete ? onDelete(id) : undefined}>
                    <Trash size={18} className={cn("transition-colors duration-300 fill-gray-500 text-gray-500")}/>
